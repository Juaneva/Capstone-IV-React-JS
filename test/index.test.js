    ...
    it("It should return the correct Github user object", function (done) {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.text.should.eql(
            '[{"id":68243499,"name":"Juaneva","login":"Juaneva","avatar":"https://avatars.githubusercontent.com/u/68243499?v=4","url":"https://api.github.com/users/Juaneva","source":"Github"}]'
          );
          done();
        });
    }).timeout(5000);
...
describe("2/5: Display single user API", function () {
  ...
  describe("In the case of a correct Github user: ", function () {
    it("It should return the correct Github user object", function (done) {
      ...
      let query = { user: "Juaneva", source: "Github" };
  ...
  describe("In the case of not adding the right parameters: ", function () {
    ...
    it("Getting a 404 from Gitlab should fail the request", function (done) {
      ...
      let query = { user: "Juaneva", source: "Gitlab" };
    ...
    it("It should return the correct Github repo object", function (done) {
      ...
      chai
        ...
        .end((err, res) => {
          res.should.have.status(200);
          res.text.should.eql(
            '{"id":385521118,"name":"fedsa-project-1","description":"A mentoring project by Front End Development South Africa","created_at":"2021-07-13T07:47:10Z","updated_at":"2021-08-10T09:17:56Z","owner":"Juaneva","source":"Github"}'
          );
          done();
        });
    }).timeout(5000);
    ...
    it("It should return the correct list of Github commits for that repo", function (done) {
      ...
      chai
        ...
        .end((err, res) => {
          res.should.have.status(200);
          res.text.should.eql(
            '[{"id":"2aeef88bdfecd84e3d314fea07aec5ebb2113e6e","message":"Merge pull request #9 from Juaneva/feat/liked-products\\n\\nFeat/liked products","committed_date":"2021-08-10T09:17:53Z"},{"id":"49e28acadfc90e71f350726d9cbd63666e2231b8","message":"Heart button changes colour when clicked","committed_date":"2021-08-10T09:11:39Z"},{"id":"1b802b82bdc03891f3e81fade067584e72f1dffb","message":"Liked items functionality","committed_date":"2021-08-09T18:18:15Z"},{"id":"3952088193f62ce05cacf65d8164b232fb9304e2","message":"Merge pull request #8 from Juaneva/feat/cart-total\\n\\nAdd dynamic cart total to page","committed_date":"2021-08-08T17:45:32Z"},{"id":"9e7e133afa219ec5a0c3afe7a3ec951317d0e58b","message":"Add dynamic cart total to page","committed_date":"2021-08-08T17:43:16Z"}]'
          );
          done();
        });
    }).timeout(5000);
